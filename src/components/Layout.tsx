...
const Layout = ({ children }: LayoutProps) => {
  return (
    <div className="min-h-screen bg-gradient-to-br from-biblical-navy via-blue-900 to-indigo-900">
          ...
          <div className="flex items-center justify-between">
            <div className="flex items-center space-x-3 animate-fade-in">
              ...
              <div>
                ...
                <p className="text-biblical-cream/80 text-sm">Your Bible Study Companion</p>
              </div>
            </div>
          </div>
        </div>
      ...
      <footer className="glass-effect border-t border-white/20 mt-20">
        <div className="container mx-auto px-4 py-8">
          <div className="text-center text-biblical-cream/60">
